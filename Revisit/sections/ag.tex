...
\np Let $Y$ is quasi-projecitve over $\spec(A)$. Equivalently, $Y$ is a quasi-projecitve subscheme of $\mathbb{P}_{A}^n$. Then we have a very ample line bundle of $Y$ by pull-back $i^*(\o_{\mathbb{P}^n_A}(1))$.
