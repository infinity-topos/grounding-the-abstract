...
In Section 5, the FLTZ skeleton
...
\(N_{\mathbb R}\)-factor. By \cref{prop:fltz-conic}, the FLTZ skeleton
...
\begin{theorem}[Microlocal sheaf--Fukaya correspondence]\label{thm:microlocal-fukaya}
...
\mathcal W(T^*M_{\mathbb R},\Lambda_\Sigma^\infty;k)
\]
be an equivalence as in \cref{thm:microlocal-fukaya}. We use this equivalence to transport
...
sheaves proved in \cref{prop:hom-complex-comparison}.
\end{proof}
...
correspondence recalled from \cref{thm:microlocal-fukaya}. The CCC proved in \cref{thm:toric-ccc} gives an
...
coherent--constructible correspondence proved from \cref{thm:toric-ccc}. The second
equivalence is the microlocal sheaf--Fukaya correspondence from \cref{thm:microlocal-fukaya},
