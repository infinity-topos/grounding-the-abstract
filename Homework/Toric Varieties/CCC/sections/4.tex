...
\begin{proof}
By Proposition~\ref{prop:affine-equiv-graded}, \(T\)-equivariant
...
\begin{theorem}[Theta generation in the equivariant quasi-coherent category]
...
\(A_\sigma=k[\sigma^\vee\cap M]\). By Proposition 3.1, one has
...
Thus the coherent side has a distinguished set of generators indexed by
pairs \((\sigma,\chi)\).  In the next section, we will construct
corresponding constructible generators with the same indexing set.
